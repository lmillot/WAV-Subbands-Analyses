...
,
		"openrect" : [ 55.0, 157.0, 1163.0, 581.0 ],
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 118.5, 493.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ids_Leipp_moteur_resynthesis~.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ids_dsp_on_off.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 19.0, 245.5, 261.0, 207.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.5, 241.0, 235.0, 228.0 ],
					"viewvisibility" : 1
				}
...
,
						"openrect" : [ 46.0, 522.0, 718.0, 233.0 ],
						"bgcolor" : [ 0.484327, 0.566228, 0.413382, 1.0 ],
						"bglocked" : 0,
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 627.5, 64.0, 77.0, 24.0 ],
									"style" : "",
									"text" : "RESET",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 646.5, 18.0, 39.0, 39.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 828.5, 301.0, 77.0, 24.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 555.0, 191.0, 77.0, 24.0 ],
									"style" : "",
									"text" : "MASTER",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 828.5, 330.0, 105.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 854.0, 116.0, 50.0, 22.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 573.0, 14.0, 40.0, 22.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 854.0, 148.0, 20.0, 140.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 573.0, 41.0, 41.0, 140.0 ],
									"size" : 70.0,
									"style" : ""
								}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 14.5, 493.0, 61.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ids_Leipp_selection_sb.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 564.0, 465.0, 579.0, 110.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "wavFilesSelector_path.maxpat",
					"numinlets" : 0,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
...
, 			{
				"name" : "1_blues_Clapton_s441_L.jpg",
				"bootpath" : "/Volumes/Geiko/Data_Leipp/ids_figures",
				"patcherrelativepath" : "../../../../Volumes/Geiko/Data_Leipp/ids_figures",
				"type" : "JPEG",
				"implicit" : 1
			}
, 			{
